...
namespace Assignment4
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            arena.GoToNextTurn();
            Debug.Assert(arena.Turns == 1);
            Debug.Assert(arena.MonsterCount == 2);
            Debug.Assert(arena.GetHealthiest().Name == "MyMonster1");

            PrintMobList(arena.ArenaName);
            Console.WriteLine($"{"①"} |{"MyMonster1",11}{"Water",8}{"98",5}{"4",5}{"0",5} |");
            Console.WriteLine($"{"②"} |{"MyMonster2",11}{"Fire",8}{"2",5}{"0",5}{"1",5} |");
            Console.WriteLine($"{"-".PadRight(40, '-')}\n\n\n\n\n\n\n\n");
            Console.Write($"{"Continue Press Key",28}");
            Console.ReadKey();
            Console.Clear();
            ...
            Debug.Assert(arena.GetHealthiest().Name == "MyMonster4");
