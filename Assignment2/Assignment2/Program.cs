...
namespace Assignment2
{
    class Program
    {
        ...
        {
            char[,] canvas = Canvas.Draw(11, 11, EShape.Circle);
            printCanvas(canvas);
            ...
            canvas = Canvas.Draw(21, 21, EShape.Rectangle);
            printCanvas(canvas);
            ...
            canvas = Canvas.Draw(5, 3, EShape.IsoscelesTriangle);
            printCanvas(canvas);
            ...
            canvas = Canvas.Draw(11, 11, EShape.IsoscelesRightTriangle);
            printCanvas(canvas);
