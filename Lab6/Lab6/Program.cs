...
namespace Lab6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            Lab6.TransformArray(test2Row, Lab6.EMode.HorizontalMirror);
            printArray(test2Row);
            ...
            Lab6.TransformArray(test2Col, Lab6.EMode.HorizontalMirror);
            printArray(test2Col);

            data = getTestArray();

            Lab6.TransformArray(data, Lab6.EMode.HorizontalMirror);
            printArray(data);
            ...
            Lab6.TransformArray(testMn, Lab6.EMode.HorizontalMirror);
            printArray(testMn);

            int[,] test3Row = { { 112, 113, 103, 108, 44, 57, 68, 32, 144, 98, 41, 76, 100, 147, 41, 9, 29, 142, 27 } };

            Lab6.TransformArray(test3Row, Lab6.EMode.VerticalMirror);
            printArray(test3Row);
            ...
            Lab6.TransformArray(test3Col, Lab6.EMode.VerticalMirror);
            printArray(test3Col);

            data = getTestArray();

            Lab6.TransformArray(data, Lab6.EMode.VerticalMirror);
            printArray(data);
            ...
            Lab6.TransformArray(test3Mn, Lab6.EMode.VerticalMirror);
            printArray(test3Mn);

            int[,] test4Row = { { 112, 113, 103, 108, 44, 57, 68, 32, 144, 98, 41, 76, 100, 147, 41, 9, 29, 142, 27 } };

            Lab6.TransformArray(test4Row, Lab6.EMode.DiagonalShift);
            printArray(test4Row);
            ...
            Lab6.TransformArray(test4Col,Lab6.EMode.DiagonalShift);
            printArray(test4Col);

            data = getTestArray();

            Lab6.TransformArray(data, Lab6.EMode.DiagonalShift);
            printArray(data);
