...
namespace Lab6
{
    class Program
    {
        static void Main(string[] args)
        {
            ...
            //Lab6Edited.TransformArray(test2Row, Lab6Edited.EMode.HorizontalMirror);
            //printArray(test2Row);
            ...
            //Lab6Edited.TransformArray(test2Col, Lab6Edited.EMode.HorizontalMirror);
            //printArray(test2Col);

            //data = getTestArray();

            //Lab6Edited.TransformArray(data, Lab6Edited.EMode.HorizontalMirror);
            //printArray(data);
            ...
            //Lab6Edited.TransformArray(testMn, Lab6Edited.EMode.HorizontalMirror);
            //printArray(testMn);

            //int[,] test3Row = { { 112, 113, 103, 108, 44, 57, 68, 32, 144, 98, 41, 76, 100, 147, 41, 9, 29, 142, 27 } };

            //Lab6Edited.TransformArray(test3Row, Lab6Edited.EMode.VerticalMirror);
            //printArray(test3Row);
            ...
            //Lab6Edited.TransformArray(test3Col, Lab6Edited.EMode.VerticalMirror);
            //printArray(test3Col);

            //data = getTestArray();

            //Lab6Edited.TransformArray(data, Lab6Edited.EMode.VerticalMirror);
            //printArray(data);
            ...
            //Lab6Edited.TransformArray(test3Mn, Lab6Edited.EMode.VerticalMirror);
            //printArray(test3Mn);

            int[,] test4Row = { { 112, 113, 103, 108, 44, 57, 68, 32, 144, 98, 41, 76, 100, 147, 41, 9, 29, 142, 27 } };

            Lab6Edited.TransformArray(test4Row, Lab6Edited.EMode.DiagonalShift);
            printArray(test4Row);
            ...
            Lab6Edited.TransformArray(test4Col,Lab6Edited.EMode.DiagonalShift);
            printArray(test4Col);

            data = getTestArray();

            Lab6Edited.TransformArray(data, Lab6Edited.EMode.DiagonalShift);
            printArray(data);
