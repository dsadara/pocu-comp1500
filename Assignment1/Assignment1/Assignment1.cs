    ...
    public static class Assignment1
    {
        public static void PrintIntegers(StreamReader input, StreamWriter output, int width)
        {
            ...
            if (width < 10)
            {
                ...
                output.WriteLine("{0,10} {1, 10} {2, 10:X}", Convert.ToString(num1, 8), num1, num1);
                output.WriteLine("{0,10} {1, 10} {2, 10:X}", Convert.ToString(num2, 8), num2, num2);
                output.WriteLine("{0,10} {1, 10} {2, 10:X}", Convert.ToString(num3, 8), num3, num3);
                output.WriteLine("{0,10} {1, 10} {2, 10:X}", Convert.ToString(num4, 8), num4, num4);
                output.WriteLine("{0,10} {1, 10} {2, 10:X}", Convert.ToString(num5, 8), num5, num5);
            }
            else
            {
